		              	...
		              	<div class="table_top">
		              		<el-row >
			              			...
			              			<el-col :span="20" class="bg_right">
			              				...
			              				<router-link :to="'/financeManage/financeDetail/' + detailData.repaymentPreviewDto.financeNo">
			              	...
			              	<el-row>
			              			...
			              			<el-col :span="8" class="bg_right">{{detailData.repaymentPreviewDto.expireDate?detailData.repaymentPreviewDto.expireDate:'--'}}</el-col>
			              	</el-row>
			              	<el-row >
