...
export function uploadBankserial (data) {
  return fetch({
    url: test + '/risk-api/loan/upload_bankserial',
    method: 'post',
    isFormData: true,
...
export function saveBankserial ({financeNo,bankSerials,marginFlow}) {
  ...
  return fetch({
    url: test + '/risk-api/loan/save_bankserial',
    method: 'post',
    data
  })
}
...
export function viewBankserial (financeNo) {
  ...
  return fetch({
    url: test + '/risk-api/loan/view_bankserial',
    method: 'post',
    data
  })
}
...
export function confirmPass (financeNo) {
  ...
  return fetch({
    url: test + '/risk-api/loan/confirm',
    method: 'post',
    data
  })
}
...
export function capticalSign ({financeNo}) {
  ...
  return fetch({
    url: test + '/risk-api/loan/captical_sign',
    method: 'post',
    data
  })
}
