            ...
            <div class="tab-content">
              <el-form ref="form1" label-width="170px" size="mini" label-position="right">
                <div class="info-list">
                  <p class="title">征信数据</p>
                    ...
                    <Upload 
                    	...
                    	actionUrl="/risk-api/supplier_register/upload_verify" 
                ...
                <template v-for="(item, index) in queryVerifyData.centres">
                    ...
                    <el-form-item label="平台供应商编码：" style="width:450px;display: inline-block">
                    ...
                    <tr v-for="(item, index) in querySignData.creditAndIterestRates">
                      ...
                      <td style="width: 110px;">
                      	<el-input class="must_input" type="number" 
                      		v-model="querySignData.creditAndIterestRates[index].canMeltDays" 
                      		placeholder="" 
                      		:min="1"   
                      		size="mini" clearable>
                      	</el-input>
...
//      this.getQuerySignData();//授信签署
      ...
      handleUpdateKnow () {
        ...
        if (!validContent(this.queryKnowData.credit) || !validContent(this.queryKnowData.trade)) {
          this.$notify.error('贸易答疑和征信答疑都不能为空')
          return false
        }
        let data = {
          supplierId: this.supplierId,
...
//	      	}
      ...
      handleUpdateSign () {
      	if(!this.querySignData.totalCreditLine&&this.querySignData.totalCreditLine!==0){
      		this.$notify.error('总授信额度不能为空！');
      		return;
      	}
      	if(!this.querySignData.creditLineExpireTime){
      		this.$notify.error('融资额度的届满日不能为空！');
      		return;
      	}
