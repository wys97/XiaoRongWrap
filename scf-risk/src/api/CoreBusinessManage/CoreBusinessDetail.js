...
export function detail (id) {
  ...
  return fetch({
    url: test + '/risk-api/core_enterprise/detail',
    method: 'post',
    data
  })
}
...
export function coreEnterpriseUpdate ({id,enterpriseName,setUpDate,creditLine,scmSite,url,subsidiaryJsonList}) {
	...
	return fetch({
	    url: test + '/risk-api/core_enterprise/update',
	    method: 'post',
	    data
	})
}
...
export function coreEnterpriseAdd ({id,enterpriseName,setUpDate,creditLine,scmSite,url}) {
	...
	return fetch({
	    url: test + '/risk-api/core_enterprise/add',
	    method: 'post',
	    data
	})
}
...
export function coreEnterpriseDelete (id) {
	...
	return fetch({
	    url: test + '/risk-api/core_enterprise/delete',
	    method: 'post',
	    data
	})
}
