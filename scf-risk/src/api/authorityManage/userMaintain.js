...
export function getListData ({page, limit,operatorName,loginName}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/list',
    method: 'post',
    data
  })
}
...
export function addOperator ({loginName, operatorName,loginPassword}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/add',
    method: 'post',
    data
  })
}
...
export function getRoleList ({id}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/role_list',
    method: 'post',
    data
  })
}
...
export function recomposeGrantRole ({id,roleIds}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/grant_role',
    method: 'post',
    data
  })
}
...
export function updateStatus ({id,status}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/update_status',
    method: 'post',
    data
  })
}
...
export function resetPassword ({id}) {
  ...
  return fetch({
    url: test + '/risk-api/operator/reset_password',
    method: 'post',
    data
  })
}
