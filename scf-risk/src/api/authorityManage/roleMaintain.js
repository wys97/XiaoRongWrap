...
export function getPermissionList ({id}) {
  ...
  return fetch({
    url: test + '/risk-api/role/permission_list',
    method: 'post',
    data
  })
}
...
export function grantPermission ({id,permissionCodes}) {
  ...
  return fetch({
    url: test + '/risk-api/role/grant_permission',
    method: 'post',
    data
  })
}
