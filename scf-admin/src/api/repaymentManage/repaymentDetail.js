...
export function RegisterDetail (orderNo) {
  ...
  return fetch({
    url: test + '/admin/repayment/register_detail',
    method: 'post',
    data
  })
}
...
export function repaymentUpdateStatus ({orderNo,status}) {
  ...
  return fetch({
    url: test + '/admin/repayment/update_status',
    method: 'post',
    data
  })
}
...
export function incomeNewIncome () {
  return fetch({
    url: test + '/admin/income/new_income',
    method: 'post'
  })	
}
...
export function uploadBankserial (data) {
  return fetch({
    url: test + '/admin/income/upload_bankserial',
    method: 'post',
    isFormData: true,
...
export function repaymentDetail (financeNo) {
  ...
  return fetch({
    url: test + '/admin/repayment/detail',
    method: 'post',
    data
  })
}
