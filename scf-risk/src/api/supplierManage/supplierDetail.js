...
export function querySummary (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_summary',
    method: 'post',
    data
  })
}
...
export function queryBasic (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_basic',
    method: 'post',
    data
  })
}
...
export function queryBasicInspection (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_basic_inspection',
    method: 'post',
    data
  })
}
...
export function approveBasic ({amendItems, amendRemark, inspections, pass, supplierId}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/approve_basic',
    method: 'post',
    data
  })
}
...
export function queryBasicRmSummary (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_basic_rm_summary',
    method: 'post',
    data
  })
}
...
export function queryBasicRmDetail (item, supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_basic_rm_detail',
    method: 'post',
    data
  })
}
...
export function reApproveBasic (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/reapprove_basic',
    method: 'post',
    data
  })
}
...
export function queryTrade (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_trade',
    method: 'post',
    data
  })
}
...
export function queryTradeInspection (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_trade_inspection',
    method: 'post',
    data
  })
}
...
export function contractStatus (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/contract_status',
    method: 'post',
    data
  })
}
...
export function commerceFactorContract (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/commerce_factor_contract',
    method: 'post',
    data
  })
}
...
export function guaranteeAgreement (guarantorId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/guarantee_agreement',
    method: 'post',
    data
  })
}
...
export function createFactorContract (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/create_factor_contract',
    method: 'post',
    data
  })
}
...
export function createGuaranteeContract (guarantorId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/create_guarantee_contract',
    method: 'post',
    data
  })
}
...
export function approveTrade ({amendItems, amendRemark, inspections, pass, supplierId}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/approve_trade',
    method: 'post',
    data
  })
}
...
export function queryTradeRmSummary (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_trade_rm_summary',
    method: 'post',
    data
  })
}
...
export function queryTradeRmDetail (item, supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_trade_rm_detail',
    method: 'post',
    data
  })
}
...
export function reApproveTrade (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/reapprove_trade',
    method: 'post',
    data
  })
}
...
export function queryKnow (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_know',
    method: 'post',
    data
  })
}
...
export function updateKnow ({supplierId, credit, trade}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/update_know',
    method: 'post',
    data
  })
}
...
export function approveKnow (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/approve_know',
    method: 'post',
    data
  })
}
...
export function queryVerify (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_verify',
    method: 'post',
    data
  })
}
...
export function updateVerify ({supplierId, creditEnterprise, creditRepre, creditGuarantor, centres}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/update_verify',
    method: 'post',
    data
  })
}
...
export function queryVerifyRmSummary (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_verify_rm_summary',
    method: 'post',
    data
  })
}
...
export function queryVerifyRmDetail (supplierId, creditType) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_verify_rm_detail',
    method: 'post',
    data
  })
}
...
export function approveVerify (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/approve_verify',
    method: 'post',
    data
  })
}
...
export function uploadVerify (data) {
  return fetch({
    url: test + '/risk-api/supplier_register/upload_verify',
    method: 'post',
    isFormData: true,
...
export function querySign (supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_sign',
    method: 'post',
    data
  })
}
...
export function updateSign ({supplierId, capitalId, totalCreditLine, creditLineExpireTime, creditAndIterestRate}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/update_sign',
    method: 'post',
    data
  })
}
...
export function approveFinal ({supplierId, pass, rejectRemark}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/approve_final',
    method: 'post',
    data
  })
}
...
export function queryRmSummary (supplierId, rmType) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_rm_summary',
    method: 'post',
    data
  })
}
...
export function saveApproveTrade(supplierId, vendorCode) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/saveApprove_trade',
    method: 'post',
    data
  })
...
export function informationCheck({supplierId, type}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/information_check',
    method: 'post',
    data
  })
...
export function getScoreCard(supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/query_scorecard',
    method: 'post',
    data
  })
...
export function remitConfirm(supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/remit/confirm',
    method: 'post',
    data
  })
...
export function refreshTrade(supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/refresh_trade',
    method: 'post',
    data
  })
...
export function addCentre({supplierId,centreIds}) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/add_centre',
    method: 'post',
    data
  })
...
export function centreList(supplierId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/centre_list',
    method: 'post',
    data
  })
...
export function contractSignNameList(centreId) {
  ...
  return fetch({
    url: test + '/risk-api/supplier_register/contract_sign_name',
    method: 'post',
    data
  })
