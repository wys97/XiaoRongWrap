    ...
    for (let i = 0, l = data.length; i < l; i++) {
      ...
      switch (data[i]) { // "system_config.menu","system_config.operator_list.menu","system_config.operator_list.update"
        case 'supplier_manage.menu':
          per = 'supplier_manage_menu'                               // ===========商户管理菜单  对应role你里面的roleName
          break
        case 'supplier_manage.register_list.menu':
          per = 'supplier_manage_register_list_menu'                 // ============商户入驻菜单
          break
        case 'supplier_manage.register_list.view':
          per = 'supplier_manage_register_list_view'                 // ============商户入驻 查看	
          break
        case 'supplier_manage.register_list.add':
          per = 'supplier_manage_register_list_add'                  // ============商户入驻 保存
          break
        case 'supplier_manage.register_list.audit':
          per = 'supplier_manage_register_list_audit'                // ============商户入驻 初审
          break
        case 'supplier_manage.register_list.review':
          per = 'supplier_manage_register_list_review'               // ============商户入驻 复审
          break
        ...
        case 'capital_manager.menu':
          per = 'capital_manager_menu'                  // ============资金方管理 菜单
          break
        case 'capital_manager.capital_list.menu':
          per = 'capital_manager_capital_list_menu'               // ============资金方管理 查看
          break  
        case 'capital_manager.capital_list.list':
          per = 'capital_manager_capital_list_list'               // ============资金方管理 查看
          break  
        case 'capital_manager.capital_list.detail':
          per = 'capital_manager_capital_list_detail'               // ============资金方管理 查看详情
          break  
        case 'capital_manager.capital_list.applyCertificate':
          per = 'capital_manager_capital_list_applyCertificate'               // ============资金方管理 申请数字证书
          break  
        ...
        case 'credit_manage.menu':
          per = 'credit_manage_menu'                	 // ============授信管理
          break
        case 'credit_manage.supplier_credit.menu':
          per = 'credit_manage_supplier_credit_menu'                	 // ============商户授信情况
          break
        case 'credit_manage.supplier_credit.list':
          per = 'credit_manage_supplier_credit_list'                	 // ============商户授信情况----查看列表
          break
        case 'credit_manage.supplier_credit.detail':
          per = 'credit_manage_supplier_credit_detail'                	 // ============商户授信情况----查看详情
          break
      }
      permission[per] = true
   }
