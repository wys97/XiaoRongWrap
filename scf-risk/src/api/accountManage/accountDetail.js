...
export function riskResult (receivableNo) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/risk_result',
    method: 'post',
    data
  })
}
...
export function uploadBankserial (data) {
  return fetch({
    url: test + '/risk-api/account_receivable/upload_bankserial',
    method: 'post',
    isFormData: true,
...
export function saveBankserial ({receivableNo,bankSerials}) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/save_bankserial',
    method: 'post',
    data
  })
}
...
export function viewBankserial (receivableNo) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/view_bankserial',
    method: 'post',
    data
  })
}
...
export function bankSerialMatch (receivableNo) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/bank_serial_match',
    method: 'post',
    data
  })
}
...
export function tradeMatch (receivableNo) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/trade_match',
    method: 'post',
    data
  })
}
...
export function reach (receivableNo) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/reach',
    method: 'post',
    data
  })
}
...
export function unReach ({receivableNo,reason}) {
  ...
  return fetch({
    url: test + '/risk-api/account_receivable/un_reach',
    method: 'post',
    data
  })
}
